    ...
    if(method === 'Card') {
        ...
        fields.innerHTML = `
            <div class="p-4 bg-white rounded-4 border text-center">
                ...
                <p class="small text-muted">you  <strong>RS 1,705.50</strong> will have to deposit it at the cash counter..</p>
            </div>`;
    } else {
        fields.innerHTML = `
            <div class="mb-3">
            ...
            <p class="small text-muted border p-2 rounded">Note: After online payment transfer save transaction ID Necessary..</p>`;
    }
}
...
document.getElementById('billingForm').addEventListener('submit', function(e) {
    ...
    details.innerHTML = `Aapki <strong>${paymentData.amount}</strong> The payment has been processed.<br><small>${paymentData.date}</small>`;
